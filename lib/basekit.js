...
import { pipe, toPairs, find, head, propOr, pickBy, test, pick, keys, mapObjIndexed, includes, cond, isNil, identity, is, prop, T, reduce, when, assoc, mergeRight } from 'ramda';
