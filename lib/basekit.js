...
var plugins = [backgroundClip, crossFade, cursor, filter$1, flexboxOld, gradient, grid, imageSet, logical, position, sizing, transition, flex];
...
var Scrollbars = index.Scrollbars;
